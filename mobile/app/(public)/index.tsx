...
import { StyleSheet, ScrollView, View, Text, TouchableOpacity, Animated, Dimensions } from "react-native";
...
function AccordionItem({ q, a, defaultOpen }: { q: string; a: string; defaultOpen?: boolean }) {
  ...
  return (
    <View style={faqStyles.item}>
      <TouchableOpacity style={faqStyles.toggle} onPress={toggle} activeOpacity={0.7}>
        ...
        <Ionicons name="chevron-down" size={18} color="#00281D" style={{ opacity: 0.3, transform: [{ rotate: open ? "180deg" : "0deg" }] }} />
      </TouchableOpacity>
      {open && (
    ...
    <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.heroContainer}>
        <View style={styles.heroContent}>
          ...
          <View style={styles.heroButtons}>
            <TouchableOpacity style={styles.primaryButton} onPress={() => handleRegister("worker")} activeOpacity={0.9}>
              <Text style={styles.primaryButtonText}>Start earning</Text>
              <Ionicons name="arrow-forward" size={16} color="white" />
            </TouchableOpacity>
            <TouchableOpacity style={styles.secondaryButton} onPress={() => handleRegister("buyer")} activeOpacity={0.9}>
            ...
            <View style={styles.dashboardContent}>
              ...
              <View style={styles.statsRow}>
                ...
                <View style={styles.statCard}>
                  ...
                  <Text style={styles.earnedValue}>620 <Text style={styles.earnedLabel}>coins</Text></Text>
                  <Text style={styles.earnedSubtext}>≈ $31.00</Text>
                </View>
              </View>
              <View style={styles.taskCard}>
                <View style={styles.taskHeader}>
                  <Text style={styles.taskTitle}>Write a 5-star product review</Text>
                  <View style={styles.taskRewardBadge}>
                    <Text style={styles.taskRewardText}>+20 coins</Text>
                  </View>
                </View>
                <Text style={styles.taskDesc}>Take a screenshot of your review and submit proof.</Text>
      ...
      <View style={styles.trustedBy}>
        ...
        <View style={styles.trustedLogos}>
          {["TechCorp", "DataFlow", "AILabs", "CloudSync", "NexGen", "PixelWorks"].map((b) => (
            <View key={b} style={styles.trustedBadge}>
      ...
      <View style={styles.howSection}>
        <View style={styles.howHeader}>
          <Text style={styles.howTitle}>Precision Engineering for Every Workflow</Text>
          <Text style={styles.howSubtitle}>Whether you're looking to complete micro-tasks or scale your operations, TaskHub provides the infrastructure.</Text>
        </View>
      ...
      <View style={styles.workerFeatures}>
        <View style={styles.workerFeaturesInner}>
          <View style={styles.workerFeaturesLeft}>
            ...
            <Text style={styles.sectionTitle}>Work on your terms, get paid for your precision</Text>
            {WORKER_FEATURES.map((f) => (
              <View key={f.title} style={styles.featureRow}>
                <Ionicons name={f.icon as any} size={20} color="#4A9782" style={{ marginTop: 2 }} />
                <View style={{ flex: 1 }}>
          ...
          <View style={styles.workerFeaturesRight}>
            <View style={styles.testimonialCard}>
              <View style={styles.testimonialBgIcon}>
                <Ionicons name="cash" size={60} color="#DCD0A8" style={{ opacity: 0.1 }} />
              </View>
              <View style={styles.testimonialHeader}>
                ...
                <View>
                  ...
                  <Text style={styles.testimonialRole}>Top Contributor · Level 4</Text>
                </View>
              ...
              {[
                ...
                <View key={t.task} style={styles.taskRow}>
                  <Text style={styles.taskRowName} numberOfLines={1}>{t.task}</Text>
                  <View style={styles.taskRowMeta}>
                    <Text style={styles.taskRowReward}>{t.reward}</Text>
                    <View style={[styles.taskRowStatus, t.status === "Approved" ? styles.statusApproved : styles.statusPending]}>
                      <Text style={[styles.taskRowStatusText, t.status === "Approved" ? styles.statusApprovedText : styles.statusPendingText]}>{t.status}</Text>
                    </View>
                  </View>
                </View>
              ))}
              ...
              <TouchableOpacity style={styles.withdrawBtn} onPress={() => handleRegister("worker")} activeOpacity={0.9}>
      ...
      <View style={styles.buyerFeatures}>
        <View style={styles.buyerFeaturesInner}>
            ...
            <View style={styles.opsCard}>
              ...
              <View style={styles.chartContainer}>
                {[20, 40, 80, 60, 90, 50].map((h, i) => (
                  <View key={i} style={[styles.chartBar, (i === 2 || i === 4) && styles.chartBarActive, { height: `${h}%` }]} />
                ))}
              </View>
          ...
          <View style={styles.buyerFeaturesLeft}>
            ...
            <Text style={styles.sectionTitle}>Deploy micro-tasks at global scale with zero friction</Text>
            {BUYER_FEATURES.map((f) => (
              <View key={f.title} style={styles.featureRow}>
                <Ionicons name={f.icon as any} size={20} color="#004030" style={{ marginTop: 2 }} />
                <View style={{ flex: 1 }}>
                  <Text style={styles.featureTitle}>{f.title}</Text>
                  <Text style={styles.featureDesc}>{f.desc}</Text>
                </View>
          ...
          <View style={styles.coinInfo}>
            ...
            <View style={{ gap: 12 }}>
              <View style={styles.coinRow}>
                ...
                <Text style={styles.coinRowText}><Text style={styles.coinRowBold}>Buyers</Text> purchase 10 coins for $1 USD.</Text>
              </View>
              <View style={styles.coinRow}>
                <Ionicons name="cash" size={18} color="#4A9782" />
                <Text style={styles.coinRowText}><Text style={styles.coinRowBold}>Workers</Text> withdraw $1 USD per 20 coins earned.</Text>
              </View>
              <View style={styles.coinRow}>
                <Ionicons name="information-circle" size={18} color="#4A9782" />
                <Text style={styles.coinRowText}>The spread between buy and withdraw rates sustains the platform.</Text>
              </View>
            </View>
          </View>
          <View style={styles.packages}>
            {COIN_PACKAGES.map((pkg) => (
              ...
              >
                ...
                <Text style={[styles.pkgLabel, selectedPkg === pkg.id && styles.pkgLabelSelected]}>{pkg.label}</Text>
                <Text style={[styles.pkgCoins, selectedPkg === pkg.id && styles.pkgCoinsSelected]}>{pkg.coins.toLocaleString()}</Text>
                <Text style={[styles.pkgCoinsLabel, selectedPkg === pkg.id && styles.pkgCoinsLabelSelected]}>coins</Text>
      ...
      <View style={styles.contributors}>
        <View style={styles.contributorsHeader}>
          <View>
            ...
            <Text style={styles.contributorsSubtitle}>Recognizing our highest-performing task masters this month.</Text>
          </View>
          <TouchableOpacity onPress={() => router.push("/(public)/leaderboard")} style={styles.leaderboardLink}>
            <Text style={styles.leaderboardLinkText}>View leaderboard</Text>
            <Ionicons name="arrow-forward" size={14} color="#4A9782" />
          </TouchableOpacity>
        </View>
        <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.contributorsScrollView}>
          {[
            ...
            <View key={w.name} style={styles.contributorCard}>
              <View style={styles.contributorAvatarRow}>
                <View style={styles.contributorAvatar}>
                  <Text style={styles.contributorAvatarInitial}>{w.name[0]}</Text>
                </View>
              ...
              <View style={styles.contributorStats}>
                <View style={styles.contributorStatBox}>
                  ...
                  <View style={styles.contributorStatValue}>
                    ...
                    <Text style={styles.contributorStatNumber}>{w.coins.toLocaleString()}</Text>
                  </View>
                </View>
                <View style={styles.contributorStatBox}>
                  <Text style={styles.contributorStatLabel}>APPROVED</Text>
                  <Text style={styles.contributorStatNumberAlt}>{w.approval}</Text>
                </View>
              </View>
            </View>
          ))}
      ...
      <View style={styles.communitySection}>
        <View style={styles.communityInner}>
          <View style={styles.testimonialFeatured}>
            ...
            <Text style={styles.featuredQuote}>"TaskHub transformed our data annotation process. We scaled from 100 to 10,000 labels a day without sacrificing quality."</Text>
            <View style={styles.quoteAuthor}>
              ...
              <View>
                ...
                <Text style={styles.quoteAuthorRole}>HEAD OF AI AT DATASTREAM</Text>
              </View>
            </View>
          </View>
          <View style={styles.testimonialCards}>
            <View style={styles.testimonialCardSm}>
              ...
              <Text style={styles.testimonialQuote}>"Consistent payouts and a clean interface. Best micro-task platform I've used."</Text>
              <Text style={styles.testimonialAuthor}>Elena Petrova · <Text style={styles.testimonialAuthorSub}>Verified Task Master</Text></Text>
            </View>
            <View style={styles.testimonialCardSm}>
              <Ionicons name="flash" size={20} color="#4A9782" />
              <Text style={[styles.testimonialQuote, { marginTop: 8 }]}>"Lightning fast turnaround on our marketing outreach tasks. What used to take a week now takes four hours."</Text>
              <Text style={styles.testimonialAuthor}>David Chen · <Text style={styles.testimonialAuthorSub}>Startup Founder</Text></Text>
            </View>
          </View>
        </View>
      </View>
      ...
      <View style={styles.impactSection}>
        ...
        <Text style={styles.impactSubtitle}>TaskHub isn't just a platform; it's a movement providing fair-wage opportunities to individuals in 140+ countries.</Text>
      ...
      <View style={styles.faqSection}>
        <View style={styles.faqInner}>
          <View style={styles.faqHeader}>
            ...
            <Text style={styles.faqSubtitle}>Can't find the answer you're looking for? Reach out to our support team.</Text>
            <TouchableOpacity style={styles.supportBtn} onPress={() => router.push("/(public)/support")}>
      ...
      <View style={styles.ctaSection}>
        ...
        <Text style={styles.ctaSubtitle}>Join the most efficient micro-tasking network today. Signing up takes less than 2 minutes.</Text>
        <View style={styles.ctaButtons}>
          <TouchableOpacity style={styles.ctaPrimaryBtn} onPress={() => handleRegister("worker")} activeOpacity={0.9}>
            <Text style={styles.ctaPrimaryBtnText}>Get Started Now</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.ctaSecondaryBtn} onPress={() => router.push("/(public)/browse-tasks")} activeOpacity={0.9}>
