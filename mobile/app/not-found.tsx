...
const styles = StyleSheet.create({
  ...
  iconWrapper: { width: 88, height: 88, borderRadius: 44, backgroundColor: "rgba(255,255,255,0.8)", alignItems: "center", justifyContent: "center", shadowColor: "#000", shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.1, shadowRadius: 12, elevation: 8 },
